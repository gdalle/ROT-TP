...
!!! note "Getting started"
	...
	If you are not familiar with this environment, please read my [introduction to Julia and Pluto](https://gdalle.github.io/IntroJulia/basics.html) before writing your first lines of code. This is especially important because Pluto is *reactive* and has no notion of execution order: if you are used to Jupyter, you are in for a surprise.

	The [JuMP documentation](https://jump.dev/JuMP.jl/stable/tutorials/getting_started/introduction/) is a good resource for syntax basics, and it will help you understand how optimization problems are formulated and solved below.
"""
...
plot_network(diamond_network(), vx=[0, 1, 1, 2], vy=[0, 1, -1, 0])
